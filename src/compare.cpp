...
int main() {
    ...
    // Test different languages - just change the enum value below
    lang_test(Language::French);    // Change this to English, French, or Russian
...
int lang_test(Language lang) {
    ...
    switch(lang){
        case English:
            output_file_name = "../results/eng_stem.csv";
            dif_file_name = "../results/eng_stem_dif.csv";
            ...
            break;
        case French:
            output_file_name = "../results/fre_stem.csv";
            dif_file_name = "../results/fre_stem_dif.csv";
            ...
            break;
        case Russian:
            output_file_name = "../results/rus_stem.csv";
            dif_file_name = "../results/rus_stem_dif.csv";
            data_file_name = "../data/russian_utf-8.txt";
